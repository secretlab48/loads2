...
registerBlockType('download-manager/posts', {
    title: 'Post Grid',

    description: 'Query Blog Posts',

    keywords: [__('post blog posts'), __('post loop'), __('wp_query')],
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(SelectControl, {
                            ...
                            'class': "form-control wpdm-custom-select",
                            options: [{ label: 'Publish Date', value: 'date' }, { label: 'Update Date', value: 'updated' }, { label: "Title", value: 'title' }],
