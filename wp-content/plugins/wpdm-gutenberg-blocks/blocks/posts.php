...
class Posts{
    ...
    function __construct(){
        ...
        add_filter( 'wpdm_tpl_dir', array($this, 'registerTplPath'));
        add_action( 'admin_head', array($this, 'templates'), 9 );
    }


    function registerTplPath($paths){
        $_paths[] = get_template_directory()."/download-manager/gutenberg/";
        $_paths[] = get_stylesheet_directory()."/download-manager/gutenberg/";
        $paths = $_paths + $paths;
        return $paths;
    }
