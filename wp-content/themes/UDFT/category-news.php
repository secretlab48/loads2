...
$args['post_type'] = 'post';
$args['tax_query'] = array( 'relation' => 'OR', array( 'taxonomy' => 'category', 'field' => 'slug', 'terms' => array( 'news' ) ) );
        ...
        <section class="news-content-section">
            <div class="custom-container p0">
                ...
                if ( count( $news ) > 0 ) {
                    ...
                    echo loads_get_pagination( array( 'page' => $current_page, 'q' => $count_posts, 'ppp' => $ppp, 'base' => site_url() . '/' . 'category/news', 'qs' => preg_replace( '/page\/[0-9]+\//', '', $_SERVER['QUERY_STRING'] ) ) );
                }
                else {
