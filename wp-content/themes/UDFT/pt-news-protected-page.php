...
/**
 * Template Name: News Protected Page Template
 * The template for display News Protected Page
 *
 */
...
if ( !is_user_logged_in() ) { $args['meta_query'] = array( array( 'key' => '_userpro_edit_restrict', 'value'   => 'none', 'compare' => '=' ) ); }
